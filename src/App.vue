     ...
     <template v-if="tickers.length"> 
      ...
      <dl class="mt-5 grid grid-cols-1 gap-5 sm:grid-cols-3">
        <div
          ...
          @click="sell = t"
          :class="{
            'border-4': sell === t //border4 если sell == t 
      ...
      add(){
        ...
        setInterval( async () => {
          const resp = await fetch(
            `https://min-api.cryptocompare.com/data/price?fsym=${currentTicker.name}&tsyms=USD&api_key=7c6c6cb5475c51ae3c53b8d29997df4a33315cd001c15cdff547c6056face0e8`);
